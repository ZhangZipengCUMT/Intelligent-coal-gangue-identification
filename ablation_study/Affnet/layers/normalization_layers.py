...
from Affnet.layers.normalization import build_normalization_layer, NORM_LAYER_CLS
...
def get_complex_normalization_layer(
    ...
    class ComplexNorm(nn.Module):
        ...
        def __init__(self, opts, num_features, norm_type, num_groups):
            ...
            self.bn_r = build_normalization_layer(cfg, num_features, norm_type, num_groups)
            self.bn_i = build_normalization_layer(cfg, num_features, norm_type, num_groups)
...
def get_normalization_layer(
    ...
    **kwargs
    ...
    Helper function to get normalization layers
    """
    return build_normalization_layer(cfg, num_features, norm_type, num_groups)
