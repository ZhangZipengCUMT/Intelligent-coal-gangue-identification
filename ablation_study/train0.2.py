...
shutil.copy("train0.2.py", os.path.join(save_folder, "train0.2.py"))
...
optimizer = optim.Adam(model.parameters(), lr=9.2e-5)
model.to(device)
...
if __name__ == '__main__':
    ...
    pd.DataFrame(his, columns=["epoch", "loss", "acc", "test_acc"]).to_csv(os.path.join(save_folder, "Train_newhis.csv"))
